...
function hideTooltip(immediate = false) {
  ...
  const doHide = () => {
    if (currentAnchor.value && tooltipId.value) {
      try { currentAnchor.value.removeAttribute('aria-describedby') } catch {}
    }
...
<template>
  ...
  <!-- Teleported tooltip -->
  <Tooltip :visible="tooltipVisible" :anchorEl="currentAnchor" :content="tooltipContent" :placement="tooltipPlacement" />
